...
-- Items
local TransitLamps = script.Parent.Parent.Parent.Transit.Interior.TransitLamps
local TransitSmallLamps = script.Parent.Parent.Parent.Transit.Interior.TransitSmallLamps
--
