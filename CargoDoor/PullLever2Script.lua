...
local MainLeverValue = script.Parent.Parent.Parent.Parent.Parent.CargoDoorConsole1.PullLever.CPU.Values.LeverValue
...
MainLeverValue.Changed:Connect(function()
	if MainLeverValue.Value == "FULL" then
		PullIn()
	elseif MainLeverValue.Value == "LOW" then
		PullOut()
	end
end)
