...
-- Values
local ElevatorCurrentFloorValue = script.Parent.Parent.Parent.Parent.Parent.CPU.Values.ElevatorCurrentStationValue
local ElevatorTargetFloorValue = script.Parent.Parent.Parent.Parent.Parent.CPU.Values.ElevatorTargetStationValue
local ElevatorStatusValue = script.Parent.Parent.Parent.Parent.Parent.CPU.Values.ElevatorStatusValue
--
