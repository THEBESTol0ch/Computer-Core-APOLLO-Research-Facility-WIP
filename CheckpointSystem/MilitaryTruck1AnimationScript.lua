...
local ObjectMove18 = {
	CFrame = Pos19.CFrame:ToWorldSpace(CFrame.new(0, 0, 0))
}
local ObjectMove19 = {
...
local ObjectMove17 = TweenService:Create(MilitaryTruckPrimaryPart, ObjectAnimationSettingsMove, ObjectMove17)
local ObjectMove18 = TweenService:Create(MilitaryTruckPrimaryPart, ObjectAnimationSettingsEvac, ObjectMove18)
local ObjectMove19 = TweenService:Create(MilitaryTruckPrimaryPart, ObjectAnimationSettingsMove, ObjectMove19)
