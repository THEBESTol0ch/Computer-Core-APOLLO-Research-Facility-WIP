...
local ObjectMove6 = TweenService:Create(HMMWVPrimaryPart, ObjectAnimationSettingsStart, ObjectMove6)
...
local ObjectMove10 = TweenService:Create(HMMWVPrimaryPart, ObjectAnimationSettingsEnd, ObjectMove10)
local ObjectMove11 = TweenService:Create(HMMWVPrimaryPart, ObjectAnimationSettingsStart, ObjectMove11)
...
local ObjectMove15 = TweenService:Create(HMMWVPrimaryPart, ObjectAnimationSettingsMove, ObjectMove15)
local ObjectMove16 = TweenService:Create(HMMWVPrimaryPart, ObjectAnimationSettingsMove, ObjectMove16)
local ObjectMove17 = TweenService:Create(HMMWVPrimaryPart, ObjectAnimationSettingsEvac, ObjectMove17)
local ObjectMove18 = TweenService:Create(HMMWVPrimaryPart, ObjectAnimationSettingsMove, ObjectMove18)
